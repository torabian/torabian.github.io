...
import (
	"embed"
	"github.com/myorg/mynewbackend/modules/pkp-info/migrations"
...
type PkpInfoModuleConfig struct {
...
func PkpInfoModuleSetup(cfg *PkpInfoModuleConfig) *fireback.ModuleProvider {
	module := &fireback.ModuleProvider{
		...
		ActionsBundle: GetPkpInfoActionsBundle(),
