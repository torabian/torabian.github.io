...
import (
	"embed"
	"github.com/myorg/mynewbackend/modules/pkpsync/migrations"
...
type PkpSyncModuleConfig struct {
...
func PkpSyncModuleSetup(cfg *PkpSyncModuleConfig) *fireback.ModuleProvider {
	module := &fireback.ModuleProvider{
		...
		ActionsBundle: GetPkpSyncActionsBundle(),
