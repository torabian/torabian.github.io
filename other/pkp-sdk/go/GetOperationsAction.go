...
// GetOperationsActionRaw registers a raw Gin route for the GetOperationsAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func GetOperationsActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := GetOperationsActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// GetOperationsActionHandler returns the HTTP method, route URL, and a typed Gin handler for the GetOperationsAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func GetOperationsActionHandler(
	handler func(c GetOperationsActionRequest) (*GetOperationsActionResponse, error),
...
// GetOperationsActionGin is a high-level convenience wrapper around GetOperationsActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func GetOperationsActionGin(r gin.IRoutes, handler func(c GetOperationsActionRequest) (*GetOperationsActionResponse, error)) {
	method, url, h := GetOperationsActionHandler(handler)
	r.Handle(method, url, h)
}
func (x GetOperationsActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func GetOperationsActionQueryFromGin(c *gin.Context) GetOperationsActionQuery {
	return GetOperationsActionQueryFromString(c.Request.URL.RawQuery)
}
...
// GetOperationsActionHttpHandler returns the HTTP method, the ServeMux pattern, and a
// typed net/http handler for the GetOperationsAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GetOperationsActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GetOperationsActionHttpHandler(
	handler func(c GetOperationsActionRequest) (*GetOperationsActionResponse, error),
...
// GetOperationsActionHttp is a high-level convenience wrapper around
// GetOperationsActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GetOperationsActionHttp(
	mux *http.ServeMux,
	handler func(c GetOperationsActionRequest) (*GetOperationsActionResponse, error),
) {
	method, pattern, h := GetOperationsActionHttpHandler(handler)
