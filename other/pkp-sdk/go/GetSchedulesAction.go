...
// GetSchedulesActionRaw registers a raw Gin route for the GetSchedulesAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func GetSchedulesActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := GetSchedulesActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// GetSchedulesActionHandler returns the HTTP method, route URL, and a typed Gin handler for the GetSchedulesAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func GetSchedulesActionHandler(
	handler func(c GetSchedulesActionRequest) (*GetSchedulesActionResponse, error),
...
// GetSchedulesActionGin is a high-level convenience wrapper around GetSchedulesActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func GetSchedulesActionGin(r gin.IRoutes, handler func(c GetSchedulesActionRequest) (*GetSchedulesActionResponse, error)) {
	method, url, h := GetSchedulesActionHandler(handler)
	r.Handle(method, url, h)
}
func (x GetSchedulesActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func GetSchedulesActionQueryFromGin(c *gin.Context) GetSchedulesActionQuery {
	return GetSchedulesActionQueryFromString(c.Request.URL.RawQuery)
}
...
// GetSchedulesActionHttpHandler returns the HTTP method, the ServeMux pattern, and a
// typed net/http handler for the GetSchedulesAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GetSchedulesActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GetSchedulesActionHttpHandler(
	handler func(c GetSchedulesActionRequest) (*GetSchedulesActionResponse, error),
...
// GetSchedulesActionHttp is a high-level convenience wrapper around
// GetSchedulesActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GetSchedulesActionHttp(
	mux *http.ServeMux,
	handler func(c GetSchedulesActionRequest) (*GetSchedulesActionResponse, error),
) {
	method, pattern, h := GetSchedulesActionHttpHandler(handler)
