...
var PERM_ROOT_PLUGIN_EVERYTHING = fireback.PermissionInfo{
	CompleteKey: "root.modules.plugin.*",
}
var ALL_PERM_PLUGIN_MODULE = []fireback.PermissionInfo{
	PERM_ROOT_PLUGIN_EVERYTHING,
}
