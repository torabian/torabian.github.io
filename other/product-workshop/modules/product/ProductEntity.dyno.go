...
import (
	...
	mocks "github.com/myorg/mynewmicroservice/modules/product/mocks/Product"
	seeders "github.com/myorg/mynewmicroservice/modules/product/seeders/Product"
...
type ProductAssets struct {
	...
	// The file (image/video) anything which is an asset to be used or shown
	Asset fireback.XFile `json:"asset" xml:"asset" yaml:"asset"    gorm:"embedded;embeddedPrefix:asset_"      `
	// Custom tag string for the asset to group or recognize later on.
	Tag      string         `json:"tag" xml:"tag" yaml:"tag"        `
	LinkedTo *ProductEntity `yaml:"-" gorm:"-" json:"-" sql:"-" xml:"-"`
}

func (x *ProductAssets) RootObjectName() string {
...
type ProductParameters struct {
	...
	// Keep a value of the parameter snapshot for case deleted original value
	ParameterSnapshot string `json:"parameterSnapshot" xml:"parameterSnapshot" yaml:"parameterSnapshot"  validate:"required"        `
	// The field value in case of string
	Value string `json:"value" xml:"value" yaml:"value"        `
	// The field value in case of numeric values
	ValueNumeric float64        `json:"valueNumeric" xml:"valueNumeric" yaml:"valueNumeric"        `
	LinkedTo     *ProductEntity `yaml:"-" gorm:"-" json:"-" sql:"-" xml:"-"`
}

func (x *ProductParameters) RootObjectName() string {
	return "ProductEntity"
}

type ProductEntityQs struct {
	Name        fireback.QueriableField `cli:"name" table:"product" typeof:"string" column:"name" qs:"name"`
	Description fireback.QueriableField `cli:"description" table:"product" typeof:"text" column:"description" qs:"description"`
	Assets      fireback.QueriableField `cli:"assets" table:"product" typeof:"array" column:"assets" qs:"assets"`
	Parameters  fireback.QueriableField `cli:"parameters" table:"product" typeof:"array" column:"parameters" qs:"parameters"`
}
...
var ProductQsFlags = []cli.Flag{
	...
	&cli.StringFlag{
		Name:  "description",
		Usage: "The description of the product.",
	},
	&cli.StringFlag{
		Name:  "assets",
		Usage: "",
	...
	&cli.StringFlag{
		Name:  "parameters",
		Usage: "The product parameters snapshot",
	},
}
...
type ProductEntity struct {
	...
	UpdatedFormatted string `json:"updatedFormatted,omitempty" xml:"updatedFormatted,omitempty" yaml:"updatedFormatted,omitempty" sql:"-" gorm:"-"`
	// Name of the product
	Name string `json:"name" xml:"name" yaml:"name"        translate:"true"  `
	// The description of the product.
	Description        string           `json:"description" xml:"description" yaml:"description"    gorm:"text"      translate:"true"  `
	DescriptionExcerpt *string          `json:"descriptionExcerpt" yaml:"descriptionExcerpt" xml:"descriptionExcerpt"`
	Assets             []*ProductAssets `json:"assets" xml:"assets" yaml:"assets"    gorm:"foreignKey:LinkerId;references:UniqueId;constraint:OnDelete:CASCADE"      `
	// The product parameters snapshot
	Parameters   []*ProductParameters     `json:"parameters" xml:"parameters" yaml:"parameters"    gorm:"foreignKey:LinkerId;references:UniqueId;constraint:OnDelete:CASCADE"      `
	Translations []*ProductEntityPolyglot `json:"translations,omitempty" xml:"translations,omitempty" yaml:"translations,omitempty" gorm:"foreignKey:LinkerId;references:UniqueId;constraint:OnDelete:CASCADE"`
...
type ProductFieldMap struct {
	...
	Assets      fireback.TranslatedString `yaml:"assets"`
...
func ProductAssetsActionCreate(
	dto *ProductAssets,
	query fireback.QueryDSL,
) (*ProductAssets, *fireback.IError) {
...
func ProductAssetsActionUpdate(
	query fireback.QueryDSL,
	dto *ProductAssets,
) (*ProductAssets, *fireback.IError) {
	dto.LinkerId = fireback.NewString(query.LinkerId)
	...
	query.Tx = dbref
	cond2 := &ProductAssets{LinkerId: fireback.NewString(query.LinkerId), UniqueId: query.UniqueId}
...
func ProductAssetsActionGetOne(
	query fireback.QueryDSL,
) (*ProductAssets, *fireback.IError) {
	refl := reflect.ValueOf(&ProductAssets{})
	item, err := fireback.GetOneEntity[ProductAssets](query, refl)
	return item, err
}
func ProductParametersActionCreate(
	dto *ProductParameters,
	query fireback.QueryDSL,
) (*ProductParameters, *fireback.IError) {
	dto.LinkerId = fireback.NewString(query.LinkerId)
	var dbref *gorm.DB = nil
	if query.Tx == nil {
		dbref = fireback.GetDbRef()
...
func ProductParametersActionUpdate(
	query fireback.QueryDSL,
	dto *ProductParameters,
) (*ProductParameters, *fireback.IError) {
	dto.LinkerId = fireback.NewString(query.LinkerId)
	...
	query.Tx = dbref
	cond2 := &ProductParameters{LinkerId: fireback.NewString(query.LinkerId), UniqueId: query.UniqueId}
	q := query.Tx.Where(cond2)
	err := q.UpdateColumns(&dto).Error
	if err != nil {
		err := fireback.GormErrorToIError(err)
...
func ProductParametersActionGetOne(
	query fireback.QueryDSL,
) (*ProductParameters, *fireback.IError) {
	refl := reflect.ValueOf(&ProductParameters{})
	item, err := fireback.GetOneEntity[ProductParameters](query, refl)
	return item, err
}
...
func (x *ProductEntity) GetDescriptionTranslated(language string) string {
	if x.Translations != nil && len(x.Translations) > 0 {
		for _, item := range x.Translations {
			if item.LanguageId == language {
...
func ProductPolyglotUpdateHandler(dto *ProductEntity, query fireback.QueryDSL) {
	...
	fireback.PolyglotUpdateHandler(dto, &ProductEntityPolyglot{}, query)
}
...
func ProductValidator(dto *ProductEntity, isPatch bool) *fireback.IError {
	...
	if dto != nil && dto.Assets != nil {
		fireback.AppendSliceErrors(dto.Assets, isPatch, "assets", err)
	}
...
Description: (type: text) Description: The description of the product.
Assets: (type: array) Description: 
Parameters: (type: array) Description: The product parameters snapshot
...
func ProductRecursiveAddUniqueId(dto *ProductEntity, query fireback.QueryDSL) {
	if dto.Assets != nil && len(dto.Assets) > 0 {
		for index0 := range dto.Assets {
			if dto.Assets[index0].UniqueId == "" {
				dto.Assets[index0].UniqueId = fireback.UUID()
			}
		}
	}
...
func ProductUpdateExec(dbref *gorm.DB, query fireback.QueryDSL, fields *ProductEntity) (*ProductEntity, *fireback.IError) {
	...
	if fields.Assets != nil {
		linkerId := uniqueId
		dbref.
			Where(&ProductAssets{LinkerId: fireback.NewString(linkerId)}).
			Delete(&ProductAssets{})
		for _, newItem := range fields.Assets {
	...
	if fields.Parameters != nil {
		linkerId := uniqueId
		dbref.
			Where(&ProductParameters{LinkerId: fireback.NewString(linkerId)}).
			Delete(&ProductParameters{})
...
func ProductActionWipeClean(query fireback.QueryDSL) (int64, error) {
	...
	var count int64 = 0
	{
		subCount, subErr := fireback.WipeCleanEntity[ProductAssets]()
		if subErr != nil {
			fmt.Println("Error while wiping 'ProductAssets'", subErr)
			return count, subErr
		} else {
			count += subCount
		}
	...
	{
		subCount, subErr := fireback.WipeCleanEntity[ProductParameters]()
		if subErr != nil {
			fmt.Println("Error while wiping 'ProductParameters'", subErr)
			return count, subErr
		} else {
			count += subCount
		}
...
var ProductCommonCliFlags = []cli.Flag{
	...
	&cli.StringFlag{
		Name:     "description",
		Required: false,
		Usage:    `The description of the product. (text)`,
	},
	&cli.StringSliceFlag{
		Name:     "assets",
		Required: false,
	...
	&cli.StringSliceFlag{
		Name:     "parameters",
		Required: false,
		Usage:    `The product parameters snapshot (array)`,
	},
}
...
func ProductCliFn() cli.Command {
	...
	return cli.Command{
		...
		Usage:       `Product is anything tangible which is sellable on the platform`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:  "language",
				Value: "en",
...
var PRODUCT_ASSETS_ACTION_PATCH = fireback.Module3Action{
	Method: "PATCH",
	Url:    "/product/:linkerId/assets/:uniqueId",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_UPDATE},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpUpdateEntity(c, ProductAssetsActionUpdate)
		},
	},
	Action:         ProductAssetsActionUpdate,
	Format:         "PATCH_ONE",
	RequestEntity:  &ProductAssets{},
	ResponseEntity: &ProductAssets{},
	Out: &fireback.Module3ActionBody{
		Entity: "ProductAssets",
	},
	In: &fireback.Module3ActionBody{
		Entity: "ProductAssets",
	},
}
var PRODUCT_ASSETS_ACTION_GET = fireback.Module3Action{
	Method: "GET",
	Url:    "/product/assets/:linkerId/:uniqueId",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_QUERY},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpGetEntity(c, ProductAssetsActionGetOne)
		},
	},
	Action:         ProductAssetsActionGetOne,
	Format:         "GET_ONE",
	ResponseEntity: &ProductAssets{},
	Out: &fireback.Module3ActionBody{
		Entity: "ProductAssets",
...
var PRODUCT_ASSETS_ACTION_POST = fireback.Module3Action{
	Method: "POST",
	Url:    "/product/:linkerId/assets",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_CREATE},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpPostEntity(c, ProductAssetsActionCreate)
		},
	},
	Action:         ProductAssetsActionCreate,
	Format:         "POST_ONE",
	RequestEntity:  &ProductAssets{},
	ResponseEntity: &ProductAssets{},
	Out: &fireback.Module3ActionBody{
...
var PRODUCT_PARAMETERS_ACTION_PATCH = fireback.Module3Action{
	Method: "PATCH",
	Url:    "/product/:linkerId/parameters/:uniqueId",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_UPDATE},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpUpdateEntity(c, ProductParametersActionUpdate)
		},
	},
	Action:         ProductParametersActionUpdate,
	Format:         "PATCH_ONE",
	RequestEntity:  &ProductParameters{},
	ResponseEntity: &ProductParameters{},
	Out: &fireback.Module3ActionBody{
		Entity: "ProductParameters",
	},
	In: &fireback.Module3ActionBody{
		Entity: "ProductParameters",
	},
}
var PRODUCT_PARAMETERS_ACTION_GET = fireback.Module3Action{
	Method: "GET",
	Url:    "/product/parameters/:linkerId/:uniqueId",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_QUERY},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpGetEntity(c, ProductParametersActionGetOne)
		},
	},
	Action:         ProductParametersActionGetOne,
	Format:         "GET_ONE",
	ResponseEntity: &ProductParameters{},
	Out: &fireback.Module3ActionBody{
		Entity: "ProductParameters",
...
var PRODUCT_PARAMETERS_ACTION_POST = fireback.Module3Action{
	Method: "POST",
	Url:    "/product/:linkerId/parameters",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_PRODUCT_CREATE},
	},
	Handlers: []gin.HandlerFunc{
		func(
			...
			fireback.HttpPostEntity(c, ProductParametersActionCreate)
		},
	},
	Action:         ProductParametersActionCreate,
	Format:         "POST_ONE",
	RequestEntity:  &ProductParameters{},
	ResponseEntity: &ProductParameters{},
	Out: &fireback.Module3ActionBody{
...
func GetProductModule3Actions() []fireback.Module3Action {
	routes := []fireback.Module3Action{
		...
		PRODUCT_ASSETS_ACTION_PATCH,
		PRODUCT_ASSETS_ACTION_GET,
		PRODUCT_ASSETS_ACTION_POST,
		PRODUCT_PARAMETERS_ACTION_PATCH,
		PRODUCT_PARAMETERS_ACTION_GET,
		PRODUCT_PARAMETERS_ACTION_POST,
	}
